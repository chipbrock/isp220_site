...
### Problem 1: Action At A Distance
...
### Problem 2: Stability of the Universe—Newton's Cosmology
...
```{figure} ./../_images/cosmology/edge.png
---
name: edge
width: 450px
align: center
---
Two pictures of a universe. One that's infinite and one that has an edge.
```
...
### Problem 3: Absolute Space and Time
